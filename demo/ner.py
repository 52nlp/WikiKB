...
def initPattern(): 
  ...
  date3 = re.compile("(([0-9]{2}|[0-9]{1}) ([J|j]anuary|[F|f]ebruary|[m|M]arch|[a|A]pril|[m|M]ay|[j|J]une|[j|J]uly|[a|A]ugust|[s|S]eptember|[o|O]ctober|[n|N]ovember|[d|D]ecember)[ ]?[,]?[ ]?(([0-9]{4})|([0-9]+ (B.C.|BC|A.D.|AD))))")

  pats = {"DISTANCE":[pattern6],"TIME":[pattern3],"AREA":[pattern7],"VOLUME":[pattern8],"CURRENCY":[pattern9,pattern10],"DATE":[date3,date1,date2,pattern,pattern4,pattern5,year],"EMAIL":[pattern2]}#,"URL":[pattern11]}
  return pats
